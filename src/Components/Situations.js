...
let arr = [
    ...
    'Когда весь день работал из дома и понял, что не встал с кресла',
    ...
    'Когда у тебя день рождения, и ты не знаешь, как реагировать на песню "С Днем Рождения"',
    'Когда кто-то говорит шутку, и ты не понял, но смеешься',
    ...
    'Когда говоришь "да" на вопрос, не слушая его',
    ...
    'Когда видишь, как кто-то делает что-то неловко, и тебе становится неловко',
...
export default function Situations () {
    ...
    const [currentSituation, setCurrentSituation] = useState(randomSituation())
