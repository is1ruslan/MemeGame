const situationsList = [
    ...
    'Как я себя чувствую, когда сижу на видеоконференции в рубашке, галстку и трусах',
    ...
    'Когда твой ТикТок набрал 236 просмотро и ты бросаешь работу ради блогерства',
    ...
    'Когда твой друг сказал, что знает короткую дорогу, и вы идете дольше обычного через через кусты и болота',
    ...
    'Это я не понимаю как я должен бороться со своими внутренними демона, когда сам тот еще чёрт',
